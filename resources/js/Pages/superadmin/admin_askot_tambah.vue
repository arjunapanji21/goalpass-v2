        ...
        <div class="card card-compact bg-base-100 shadow">
            <div class="card-body">
                <div class="text-2xl flex gap-2 font-semibold text-center">
                    <span>Tambah Admin Askot/Askab</span>
                </div>
                ...
                <div class="form-control w-full">
                    ...
                    <label class="label">
                        <span class="label-text-alt text-error italic"
                            >*Ketik ulang password yang sama.</span
                        >
                    </label>
                </div>
                <div class="card-actions justify-end">
                    ...
                    <Link :href="route('admin')" class="btn">Batal</Link>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        btn_submit() {
            this.form.post(route("askot.store"), {
                // onSuccess: () => {
                //     alert("Login Success!");
                // },
                preserveScroll: true,
