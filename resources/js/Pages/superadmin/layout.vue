<template lang="">
    ...
    <div class="block md:flex">
        <div class="bg-primary drop-shadow-lg hidden md:flex z-50">
            <ul class="menu">
                ...
                <li class="py-2">
                    ...
                    >
                        <svg
                            ...
                            height="16"
                            fill="currentColor"
                            class="bi bi-people-fill mx-auto"
                            viewBox="0 0 16 16"
                        >
                            <path
                ...
                <li class="py-2" v-if="auth.user.role == 'Super Admin' || auth.user.role == 'Admin Asprov'">
                    <Link
                        v-if="master.title == 'Wasit'"
                        :href="route('wasit.index')"
                        class="tooltip tooltip-right bg-base-100 text-primary"
                        data-tip="Wasit"
                    >
                        <svg
                ...
                <li class="py-2">
                    ...
                    >
                        <svg
                            ...
                            height="16"
                            fill="currentColor"
                            class="bi bi-person-fill-gear mx-auto"
                            viewBox="0 0 16 16"
                        >
                            <path
        ...
        <div class="w-full">
            <div class="min-h-screen bg-base-200">
                <div class="navbar bg-base-100 min-h-0 z-50">
    ...
    <div class="btm-nav bg-primary-focus md:hidden">
        <Link
            :href="route('beranda')"
        ...
        >
            ...
            <span class="btm-nav-label">Anggota</span>
        </Link>
        <Link
            :href="route('admin')"
            class="text-base-100 hover:bg-base-100 hover:text-primary"
        ...
        >
            ...
            <span class="btm-nav-label">Master</span>
        </Link>
    </div>
</template>
<script>
